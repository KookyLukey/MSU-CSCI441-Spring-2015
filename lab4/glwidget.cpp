...
mat4 createPerspectiveMatrix(float fov, float aspect, float mNear, float mFar)
{
    ...
    perspective[1][1] = f;
    perspective[2][2] = (mFar + mNear) / (mNear - mFar);
    perspective[2][3] = -1.0f;
    perspective[3][2] = (2.0f * mFar*mNear) / (mNear - mFar);
...
void GLWidget::resizeGL(int w, int h) {
    ...
    projMatrix = createPerspectiveMatrix(90.0, aspect, 1.0, 130.0);
